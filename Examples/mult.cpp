/*------------------------------------------------------------------------------------------------
  ...
  Microcluster LAN
  Programa de prueba para evaluar operaciones de multiplicacion punto flotante en GPU 
...
void walsh(Float::Ptr a, Float::Ptr b, Float::Ptr r)
{
...
// Initialise arrays
  ...
  Float::Array r(16*numQPUs);

// Initialise arrays

  srand(0);
  for (int i = 0; i < 16; i++) {
    a[i]=random_float(-1.0,1.0);
    b[i]=random_float(-1.0,1.0);
  }
